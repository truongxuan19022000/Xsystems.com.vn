...
@section('description','XSystems chuyên thiết kế website, banner, logo. Chạy quảng cáo và tăng follow titok, fb, youtube')
@section('keywords','XSystems, thiết kế website, thiết kế website trọn gói, thiết kế website giá rẻ, tăng follow titok, tăng view titok')
@section('contents')
<!-- Spinner Start -->
        <div id="spinner"
                ...
                <div class="row g-4">
                    <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                        <div class="feature-item text-center bg-service-1 rounded p-4" style="height: 300px;">
                            <img width="220" height="203" src="{{ asset('img/about.png') }}" class="attachment-full size-full" alt="xsystem-app.png" loading="lazy">
                    ...
                    <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                        <div class="feature-item text-center bg-service-2 rounded p-4" style="height: 300px;">
                            <img width="220" height="203" src="{{ asset('img/xsystem-design.png') }}" class="attachment-full size-full" alt="xsystem-design.png" loading="lazy">
                    ...
                    <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                        <div class="feature-item text-center bg-service-3 rounded p-4" style="height: 300px;">
                            <img width="220" height="203" src="{{ asset('img/xsystem-web.png') }}" class="attachment-full size-full" alt="xsystem-web.png" loading="lazy">
                    ...
                    <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                        <div class="feature-item text-center bg-service-4 rounded p-4" style="height: 300px;">
                            <img width="220" height="203" src="{{ asset('img/xsystem-web-develop.png') }}" class="attachment-full size-full" alt="xsystem-web-develop.png" loading="lazy">
                    ...
                    <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                        <div class="feature-item text-center bg-service-5 rounded p-4" style="height: 300px;">
                            <img width="220" height="203" src="{{ asset('img/xsystem-social.png') }}" class="attachment-full size-full" alt="xsystem-social.png" loading="lazy">
                    ...
                    <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                        <div class="feature-item text-center bg-service-6 rounded p-4" style="height: 300px;">
                            <img width="220" height="203" src="{{ asset('img/xsystem-management.png') }}" class="attachment-full size-full" alt="xsystem-management.png" loading="lazy">
